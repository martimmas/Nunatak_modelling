...
UserVar.OutputFileName='IceCap-thw0x1n';      % Name of the output file correspondent to this run
...
UserVar.TransRestartRef = 'RestartIceCap-spn0x1n';
...
switch CtrlVar.Experiment
    ...
    case 'Transient'  
        ...
        UserVar.NunatakShape = '0x'; % {0y|0x|Tu}
