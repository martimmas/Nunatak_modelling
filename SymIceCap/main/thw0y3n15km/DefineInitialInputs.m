...
UserVar.OutputFileName='IceCap-thw0y3n15km';      % Name of the output file correspondent to this run
...
UserVar.TransRestartRef = 'RestartIceCap-spn0y3n15km';
...
switch CtrlVar.Experiment
    ...
    case 'Transient'  
        ...
        UserVar.NunatakSpacing = 20e3; % how far away the nunataks are from each other, in m            
