...
UserVar.OutputFileName='IceCap-thw0n';      % Name of the output file correspondent to this run
...
UserVar.TransRestartRef = 'RestartIceCap-spn0n';
...
UserVar.ControlMember = '0';     % Valid for '-Control' only!
