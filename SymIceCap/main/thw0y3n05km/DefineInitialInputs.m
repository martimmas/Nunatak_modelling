...
UserVar.OutputFileName='IceCap-thw0y3n05km';      % Name of the output file correspondent to this run
...
UserVar.TransRestartRef = 'RestartIceCap-spn0y3n05km';
...
switch CtrlVar.Experiment
    ...
    case 'Transient'  
        ...
        UserVar.NunatakSpacing = 10e3; % how far away the nunataks are from each other, in m            
