...
UserVar.OutputFileName='IceCap-clthw0y1n';      % Name of the output file correspondent to this run
...
UserVar.TransRestartRef = 'RestartIceCap-clspn0y1n';
...
switch CtrlVar.Experiment
    ...
    case 'Transient'  
        ...
        UserVar.Cub     =  5.0; % 5.0 baed on log10(C) ~ 5.5; 50.0 Based on log10(C) ~ -4.5; 500 based on log10(C) ~ -3.5
