...
UserVar.OutputFileName='IceCap-spn0y1n_thk05m';      % Name of the output file correspondent to this run
...
CtrlVar.NameOfRestartFiletoWrite=['/proj/bolinc/users/x_marma/ua_files/ResultsFiles/Restart',UserVar.OutputFileName,'.mat'];
...
switch CtrlVar.Experiment
    ...
    case 'Transient'  
        ...
        if contains(UserVar.TransRestartRef,'/')
            ...
            CtrlVar.NameOfRestartFiletoRead=['/proj/bolinc/users/x_marma/ua_files/ResultsFiles/',UserVar.TransRestartRef];
        end
        ...
        UserVar.MassBalance.ScalingFile  = '/proj/bolinc/users/x_marma/ua_files/InputFiles/LR04_scaled_curve.mat'; % THIS WILL ONLY SCALE START AND END VALUES
        UserVar.MassBalance.EdgeMax      = -0.3; % maximum value at the edge for the 'linear' distribution (signal controls the slope)
        UserVar.MassBalance.CentreValue  =  1.3;
