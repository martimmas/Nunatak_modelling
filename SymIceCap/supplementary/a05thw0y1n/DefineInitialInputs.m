...
UserVar.OutputFileName='IceCap-a05thw0y1n';      % Name of the output file correspondent to this run
...
UserVar.TransRestartRef = 'RestartIceCap-a05spn0y1n';
...
switch CtrlVar.Experiment
    ...
    case 'Transient'  
        ...
        UserVar.IceTemp = -05.0; % -20 deg. C based on log10(AGlen) ~ -8.5
