...
UserVar.OutputFileName='IceCap-thw0y1n_ssmb';      % Name of the output file correspondent to this run
...
UserVar.TransRestartRef = 'RestartIceCap-spn0y1n';
...
switch CtrlVar.Experiment
    ...
    case 'Transient'  
        ...
        UserVar.MassBalance.Distribution = 'S'; %options: 'linear', 's', 'symmetrical', 'symmetrical enhanced', 'none'
        ...
        UserVar.MassBalance.CentreValue  =  0.71*1.3;% + 0.02;
