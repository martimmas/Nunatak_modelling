...
UserVar.OutputFileName='IceCap-thw0y1n_thk5m';      % Name of the output file correspondent to this run
...
UserVar.TransRestartRef = 'RestartIceCap-spn0y1n_thk5m';
...
CtrlVar.ThickMin=5.; % threshold [m] for the minimum thickness
