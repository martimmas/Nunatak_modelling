...
UserVar.OutputFileName='IceCap-retthw0y1n';      % Name of the output file correspondent to this run
...
switch CtrlVar.Experiment
    ...
    case 'Transient'  
        ...
        UserVar.CenterB      = -450; % +250 for prograde; -600 for retrograde w/ floating terminus
