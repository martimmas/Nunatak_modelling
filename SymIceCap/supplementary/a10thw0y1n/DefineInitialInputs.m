...
UserVar.OutputFileName='IceCap-a10thw0y1n';      % Name of the output file correspondent to this run
...
UserVar.TransRestartRef = 'RestartIceCap-a10spn0y1n';
...
switch CtrlVar.Experiment
    ...
    case 'Transient'  
        ...
        UserVar.IceTemp = -10.0; % -20 deg. C based on log10(AGlen) ~ -8.5
