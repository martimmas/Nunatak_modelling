...
UserVar.OutputFileName='IceCap-rettam0y1n';      % Name of the output file correspondent to this run
...
switch CtrlVar.Experiment
    ...
    case 'Transient'  
        ...
        UserVar.MassBalance.EndValue     = -0.60;    % Set mass balance value for end of run (m/yr at upstream boundary) [default: -0.1 m/a]        
