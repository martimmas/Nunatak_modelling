...
UserVar.OutputFileName='IceCap-chthw0y1n';      % Name of the output file correspondent to this run
...
UserVar.TransRestartRef = 'RestartIceCap-chspn0y1n';
...
switch CtrlVar.Experiment
    ...
    case 'Transient'  
        ...
        UserVar.Cub     =  500.0; % 50.0 Based on log10(C) ~ -4.5; 500 based on log10(C) ~ -3.5
