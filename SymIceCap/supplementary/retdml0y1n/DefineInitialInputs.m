...
UserVar.OutputFileName='IceCap-retdml0y1n';      % Name of the output file correspondent to this run
...
UserVar.TransRestartRef = 'RestartIceCap-retspn0y1n';
...
switch CtrlVar.Experiment
    ...
    case 'Transient'  
        ...
        UserVar.MassBalance.EndValue     = -0.45;    % Set mass balance value for end of run (m/yr at upstream boundary) [default: -0.1 m/a]        
        ...
        UserVar.BedrockSlope =  1e-3; % -5e-3; 1e-3 for retrograde
        UserVar.CenterB      = -600; % +250 for prograde; -600 for retrograde w/ floating terminus
